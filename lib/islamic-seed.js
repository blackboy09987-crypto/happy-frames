...
function islamic(name, img, tags) {
  return {
    ...
    img,
    sizes: SIZES,
    description: `${name} — a beautiful Islamic calligraphy wall frame that brings peace and blessings to your home. Elegant Arabic art, premium print. Available in custom A5, A4 and A3 sizes. Delivery all across Pakistan.`,
