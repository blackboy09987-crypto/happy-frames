...
function movie(name, img, tags) {
  return {
    ...
    img,
    sizes: SIZES,
    description: `A high-quality ${name} movie/series wall frame for fans. Give your room or gaming setup a cinematic look. Available in custom A5, A4 and A3 sizes. Delivery all across Pakistan.`,
