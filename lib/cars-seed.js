...
function car(name, img, model, extraTags) {
  return {
    ...
    img,
    sizes: SIZES,
    description: `A high-quality aesthetic wall frame of the ${model} that gives your room or office a sporty, premium look. Available in custom A5, A4 and A3 sizes. Handcrafted quality, delivery all across Pakistan.`,
