...
function anime(name, img, tags, isSet = false) {
  return {
    ...
    description: `A high-quality ${name} anime wall frame for anime fans. Give your room or setup a bold otaku look. Available in custom sizes. Delivery all across Pakistan.`,
...
export const ANIME = [
  ...
  anime("Ace Luffy Sabo", "/frames/anime/ace-luffy-sabo.jpg", "ace, luffy, sabo, asl brothers, one piece"),
];
