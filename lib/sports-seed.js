...
function sport(name, img, tags) {
  return {
    ...
    description: `${name} sports wall frame — high-quality print for fans. Apne room, lounge ya gaming setup ko sporty look dein. Custom sizes A5, A4 aur A3 mein available. Delivery all over Pakistan.`,
